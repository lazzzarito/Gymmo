...
export default function EntryPoint() {
  ...
  const { name, updateProfile } = useGameStore();
  ...
  const nextStep = () => {
    if (step < 3) {
      ...
      updateProfile({
        ...
        class: formData.class as 'Novato' | 'Intermedio' | 'Pro' | '',
      });
      router.push("/hub");
    }
  };
      ...
      <AnimatePresence mode="wait">
        {step === 0 && (
          ...
          >
            ...
            <PixelButton onClick={() => setStep(1)} className="w-full h-16 text-lg">
              NUEVA AVENTURA
            </PixelButton>

            <p className="text-gray-600 font-vt323 text-lg italic">&ldquo;Donde el hierro se convierte en leyenda&rdquo;</p>
          </motion.div>
        )}

        {step === 1 && (
          <motion.div key="step1" className="w-full max-w-md">
            <PixelCard>
        ...
        {step === 2 && (
          <motion.div key="step2" className="w-full max-w-md">
            <PixelCard>
        ...
        {step === 3 && (
          <motion.div key="step3" className="w-full max-w-md">
            <PixelCard>
